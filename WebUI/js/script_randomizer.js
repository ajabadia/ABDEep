    ...
    if (randBtn) {
        randBtn.addEventListener('click', () => {
            ...
            const musicalRanges = {
                ...
                "osc1_pm_source": Math.random() > 0.4 ? Math.floor(Math.random() * 23) / 23.0 : 0.0,
                "osc1_pwm_source": Math.random() > 0.5 ? Math.floor(Math.random() * 23) / 23.0 : 0.0,
                ...
                "osc2_pm_source": Math.random() > 0.4 ? Math.floor(Math.random() * 23) / 23.0 : 0.0,
                "osc2_tpm_source": Math.random() > 0.4 ? Math.floor(Math.random() * 23) / 23.0 : 0.0,
