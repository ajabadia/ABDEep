...
window._playPolyChordMemory = function(rootNote, velocity) {
    ...
    if (chordType === 0) {
        ...
        var intervals = window.CHORD_INTERVALS ? window.CHORD_INTERVALS[chordType] : null;
    ...
    var keyName = NOTE_NAMES_SHORT[keyClass];
    var typeName = CHORD_TYPE_NAMES[chordType] || 'Chord';
