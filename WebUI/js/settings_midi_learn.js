...
function initMidiLearnEditor() {
    var learnTabBtn = document.querySelector('.btn[data-tab="midilearn"]');
    ...
    var clearBtn = document.getElementById('midi-learn-clear-all');
    if (clearBtn) {
    ...
    var exportBtn = document.getElementById('midi-learn-export');
    if (exportBtn) {
    ...
    var importBtn = document.getElementById('midi-learn-import');
    var importStatus = document.getElementById('midi-learn-import-status');
    if (importBtn) {
