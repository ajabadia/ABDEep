...
std::vector<ParametersSpec::ParamInfo> ParametersSpec::getSpecs()
{
    std::vector<ParamInfo> specs = {
        ...
        { "vcf_env_depth", "VCF Envelope Depth", "filtro", "float", 0.0f, 1.0f, 0.0f, 31, 42, {} },
        ...
        { "fx1_type", "FX1 Type", "effects", "enum", 0.0f, 35.0f, 1.0f, -1, 166, { "Bypass", "HallReverb", "Plate Reverb", "Rich Plate", "Ambience", "Gated Reverb", "Reverse Reverb", "RackAmp", "Mood Filter", "Stereo Phaser", "Stereo Chorus", "Stereo Flanger", "ModDlyRev", "Delay", "3Tap Delay", "4Tap Delay", "Rotary Speaker", "Chorus-D", "Enhancer", "Edison", "AutoPan/Trem", "T-RayDelay", "tcDeepVerb", "flangVerb", "chorusVerb", "delayVerb", "ChamberRev", "RoomRev", "VintageRoom", "Dual Pitch", "MidasEQ", "FairComp", "MBDistortion", "NoiseGate", "DecimatorDelay", "Vintage Pitch" } },
        ...
        { "fx2_type", "FX2 Type", "effects", "enum", 0.0f, 35.0f, 4.0f, -1, 179, { "Bypass", "HallReverb", "Plate Reverb", "Rich Plate", "Ambience", "Gated Reverb", "Reverse Reverb", "RackAmp", "Mood Filter", "Stereo Phaser", "Stereo Chorus", "Stereo Flanger", "ModDlyRev", "Delay", "3Tap Delay", "4Tap Delay", "Rotary Speaker", "Chorus-D", "Enhancer", "Edison", "AutoPan/Trem", "T-RayDelay", "tcDeepVerb", "flangVerb", "chorusVerb", "delayVerb", "ChamberRev", "RoomRev", "VintageRoom", "Dual Pitch", "MidasEQ", "FairComp", "MBDistortion", "NoiseGate", "DecimatorDelay", "Vintage Pitch" } },
        ...
        { "fx3_type", "FX3 Type", "effects", "enum", 0.0f, 35.0f, 0.0f, -1, 192, { "Bypass", "HallReverb", "Plate Reverb", "Rich Plate", "Ambience", "Gated Reverb", "Reverse Reverb", "RackAmp", "Mood Filter", "Stereo Phaser", "Stereo Chorus", "Stereo Flanger", "ModDlyRev", "Delay", "3Tap Delay", "4Tap Delay", "Rotary Speaker", "Chorus-D", "Enhancer", "Edison", "AutoPan/Trem", "T-RayDelay", "tcDeepVerb", "flangVerb", "chorusVerb", "delayVerb", "ChamberRev", "RoomRev", "VintageRoom", "Dual Pitch", "MidasEQ", "FairComp", "MBDistortion", "NoiseGate", "DecimatorDelay", "Vintage Pitch" } },
        ...
        { "fx4_type", "FX4 Type", "effects", "enum", 0.0f, 35.0f, 0.0f, -1, 205, { "Bypass", "HallReverb", "Plate Reverb", "Rich Plate", "Ambience", "Gated Reverb", "Reverse Reverb", "RackAmp", "Mood Filter", "Stereo Phaser", "Stereo Chorus", "Stereo Flanger", "ModDlyRev", "Delay", "3Tap Delay", "4Tap Delay", "Rotary Speaker", "Chorus-D", "Enhancer", "Edison", "AutoPan/Trem", "T-RayDelay", "tcDeepVerb", "flangVerb", "chorusVerb", "delayVerb", "ChamberRev", "RoomRev", "VintageRoom", "Dual Pitch", "MidasEQ", "FairComp", "MBDistortion", "NoiseGate", "DecimatorDelay", "Vintage Pitch" } },
