...
| Suites WebUI | ✅ **105 files / 4735 tests** (4733 passed, 2 skipped, 0 fallos) · ESLint 0/0 |
...
| `vitest` + lint | webui-ci.yml | 105 files / 4735 tests + ESLint 0/0 |
...
```bash
npm test                                  # WebUI: 105 files / 4735 tests
