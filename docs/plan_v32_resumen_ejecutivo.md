...
| Suites WebUI | ✅ **105 files / 4723 tests** (4720 passed, 2 skipped, 0 fallos) · ESLint 0/0 |
...
| `vitest` + lint | webui-ci.yml | 105 files / 4723 tests + ESLint 0/0 |
...
```bash
npm test                                  # WebUI: 105 files / 4723 tests
