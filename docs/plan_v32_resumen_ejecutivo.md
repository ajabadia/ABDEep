...
| Suites WebUI | ✅ **106 files / 4745 tests** (4743 passed, 2 skipped, 0 fallos) · ESLint 0/0 |
...
| `vitest` + lint | webui-ci.yml | 106 files / 4745 tests + ESLint 0/0 |
...
```bash
npm test                                  # WebUI: 106 files / 4745 tests
