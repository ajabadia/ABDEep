...
> **2026-08-10 — actualizado a los números vigentes** (105 files / 4724 tests,
...
| Tests | **4724** (4721 passed, 2 skipped, 0 failed) |
| Duración | ~16 s |
...
- ✅ **Job `vitest` + lint** en `.github/workflows/webui-ci.yml` (ubuntu-latest): suite
  completa de WebUI (**105 files / 4724 tests, 0 fallos**) y ESLint **0 errores / 0
...
0. **Fase 0 — Inventario, Baseline y Perfilado (Pre-requisito):** este documento es la
   baseline exacta exigida por el plan — suites (105 files / 4724 tests WebUI + 126 suites /
...
7. **Fase 6 — Retirada progresiva de compatibilidad legacy:** `Logger.deprecation()`
   ...
   Baseline WebUI actualizada a 105 files / 4724 tests.
