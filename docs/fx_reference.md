...
| 4 | `density` | DEN | Density | — | 1 | 50 | Mod Matrix destination; Manipulates the reflection reflection density in the simulated room. |
...
| 4 | `release` | REL | Release | ms | 2 | 1999.9 | Adjusts the release time. |

*(Nota: Referencia importada parcialmente debido al límite de caracteres)*
